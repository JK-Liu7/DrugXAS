...
from colddata_preprocess import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pre_train', default=False, help='whether pre_train')
    ...
    parser.add_argument('--mode', default='drug', help='mode of cold-start link prediction')
    ...
    parser.add_argument('--drug_ratio', default='0.1,0.001,0.2', type=str, help='mask ratio of drug molecular augmentation')
    ...
    parser.add_argument('--net_ratio', default='0.1,0.001,0.2', type=str, help='mask ratio of network augmentation')
    ...
    data = build_cold_drug(data, args)
    data = build_cold_entity(data, args)
    data = build_cold_pair(data, args)

    if args.mode == 'drug':
        data['X_train'] = data['X_train_dr'].copy()
        data['X_train_p'] = data['X_train_p_dr'].copy()
        data['X_train_n'] = data['X_train_n_dr'].copy()
        data['X_test'] = data['X_test_dr'].copy()
        data['X_test_p'] = data['X_test_p_dr'].copy()
        data['X_test_n'] = data['X_test_n_dr'].copy()
        data['Y_train'] = data['Y_train_dr'].copy()
        data['Y_test'] = data['Y_test_dr'].copy()
    elif args.mode == 'entity':
        data['X_train'] = data['X_train_ent'].copy()
        data['X_train_p'] = data['X_train_p_ent'].copy()
        data['X_train_n'] = data['X_train_n_ent'].copy()
        data['X_test'] = data['X_test_ent'].copy()
        data['X_test_p'] = data['X_test_p_ent'].copy()
        data['X_test_n'] = data['X_test_n_ent'].copy()
        data['Y_train'] = data['Y_train_ent'].copy()
        data['Y_test'] = data['Y_test_ent'].copy()
    elif args.mode == 'pair':
        data['X_train'] = data['X_train_pair'].copy()
        data['X_train_p'] = data['X_train_p_pair'].copy()
        data['X_train_n'] = data['X_train_n_pair'].copy()
        data['X_test'] = data['X_test_pair'].copy()
        data['X_test_p'] = data['X_test_p_pair'].copy()
        data['X_test_n'] = data['X_test_n_pair'].copy()
        data['Y_train'] = data['Y_train_pair'].copy()
        data['Y_test'] = data['Y_test_pair'].copy()
